...
ADAPTER_DIR     = r"../models/bert-intent-lora-v1/ds_single"  # 训练脚本输出目录
HEAD_BIN        = os.path.join(ADAPTER_DIR, "head.bin")
HEAD_CFG        = os.path.join(ADAPTER_DIR, "head_config.json")
LABEL_MAP_PATH  = r"../data/intent/label_map_intent.json"  # 可选；若找不到则从 head_config 读取
MAX_LEN         = 256
TOPK            = 5
...
# =======================
def load_label_map():
    # 优先用 label_map；否则用 head_config 中的 id2label
